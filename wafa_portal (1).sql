...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2020 at 02:25 PM
...
CREATE TABLE `complain_status` (
  `id` int(100) NOT NULL,
  `complain_user_id` varchar(250) NOT NULL,
  `complain_user_name` varchar(250) NOT NULL,
  `complain_user_phone` varchar(250) NOT NULL,
  `complain_user_status` varchar(250) NOT NULL,
  `complain_user_email` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `complain_status` (`id`, `complain_user_id`, `complain_user_name`, `complain_user_phone`, `complain_user_status`, `complain_user_email`) VALUES
(1, '2', 'aimen', '3543254', 'inprogress', 'aimen@gmail.com'),
(2, '3', '', '', 'done', ''),
(3, '7', 'yusra ', '0808980989', 'done', 'yusra@gmail.com'),
(6, '3', 'aimen', '02323', 'inprogress', 'hasnainsaleem2233@gmail.com'),
(7, '3', 'aimen', '02323', 'inprogress', 'hasnainsaleem2233@gmail.com');
